"""ShadowNet for object-cast receiver shadows under one point light."""
...
class ShadowNet(nn.Module):
    """Predict the cleaned object-cast receiver-shadow logits."""

    def __init__(self, in_channels: int = 16, base_channels: int = 32) -> None:
        super().__init__()
        b = base_channels
    ...
    def forward(self, inputs: torch.Tensor) -> dict[str, torch.Tensor]:
        ...
        return {"shadow_logits": self.head(decoded)}
